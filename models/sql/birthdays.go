...
func (db *birthdayService) Birthdays(chat *telebot.Chat) ([]models.User, error) {
...
func (db *birthdayService) TodaysBirthdays() (map[int64][]models.User, error) {
	...
	birthdayList := make(map[int64][]models.User)
